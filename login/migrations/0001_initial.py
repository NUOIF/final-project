# Generated by Django 3.1.7 on 2021-03-31 20:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_evaluation', models.FileField(db_column='file_evaluation_dr1', default='doucment/defaultform.docx', upload_to='doucment')),
                ('file_evaluation_dr2', models.FileField(db_column='file_evaluation_dr2', default='doucment/defaultform.docx', upload_to='doucment')),
                ('file_evaluation_dr3', models.FileField(db_column='file_evaluation_dr3', default='doucment/defaultform.docx', upload_to='doucment')),
            ],
            options={
                'db_table': 'evaluation',
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('avilable', 'avilable'), ('anvilable', 'anvilable')], max_length=50, null=True)),
            ],
            options={
                'db_table': 'projects',
                'managed': False,
